...
# Functions and Permissions from MSDN Documentation
MEM_COMMIT = 0x00001000
MEM_RESERVE = 0x00002000
PAGE_READWRITE = 0x04
EXECUTE_IMMEDIATELY = 0x0
PROCESS_ALL_ACESS = (0x000F0000 | 0x00100000 | 0x00000FFF)

dll = b"<your_address>" # change your .dll 

pid = 13852 # get your pid by looking at the task manager

handle = OpenProcess(PROCESS_ALL_ACESS, False, pid)
